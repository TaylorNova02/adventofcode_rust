...
fn solve_part1_recursive(
    ...
    if offset == (ingredients.len() - 1) {
        ...
        let mut capacity: i64 = ingredients
            .iter()
            .enumerate()
        ...
        let mut durability: i64 = ingredients
            .iter()
            .enumerate()
        ...
        let mut flavor: i64 = ingredients
            .iter()
            .enumerate()
        ...
        let mut texture: i64 = ingredients
            .iter()
            .enumerate()
