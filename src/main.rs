...
fn main() {
    ...
    match (year, day) {
        ...
        (2016, 5) => year_2016::day05::run("uqwqemis"),
        ...
        // (2016, 13) => year_2016::day13::solve("1364"),
        (2016, 14) => year_2016::day14::solve("ahsbgdzn"),
        (2016, 15) => year_2016::day15::solve(&inputs::grab_local_input(year, day)),
        (2016, 16) => year_2016::day16::solve("10010000000110000"),
        // (2016, 17) => year_2016::day17::solve("mmsxrhfx"),
        (2016, 18) => year_2016::day18::solve(&inputs::grab_local_input(year, day)),
        (2016, 19) => year_2016::day19::solve(3014603),
        ...
        (2017, 3) => year_2017::day03::run(277678),
        ...
        (2017, 14) => year_2017::day14::run("jxqlasbh"),
        (2017, 15) => year_2017::day15::run(722, 354),
        (2017, 16) => year_2017::day16::run(&inputs::read_first_line(year, day)),
        (2017, 17) => year_2017::day17::run(344),
